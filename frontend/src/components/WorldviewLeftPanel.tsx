    ...
    return (
        ...
        >
            ...
            <div className="mb-6 pointer-events-auto">
                <div className="text-[10px] text-[var(--text-secondary)] font-mono tracking-widest mb-1">GEONARA // SITUATIONAL AWARENESS</div>
                <div className="text-[10px] text-[var(--text-muted)] font-mono tracking-widest mb-4">MULTI-SOURCE INTELLIGENCE FUSION</div>
